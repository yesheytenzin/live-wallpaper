...
Item {
  ...
  Process {
    id: bgSwitchProc
    command: [root.home + "/.config/omarchy/plugins/tenzin.live-wallpaper/live-wallpaper.sh"]
    onExited: root.refreshBackground()
  }

  Process {
    id: resumeLiveProc
    command: [root.home + "/.config/omarchy/plugins/tenzin.live-wallpaper/live-wallpaper.sh", "--resume"]
  }
